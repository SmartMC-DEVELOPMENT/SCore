...
import us.smartmc.survival.newvariables.DateVariables;
import us.smartmc.survival.newvariables.LuckPermsVariables;
import us.smartmc.survival.newvariables.PlayerMainVariables;

@AddonInfo(name = "survivalchat", version = "DEV")
public class ChatModule extends AddonPlugin {
    ...
    public void start() {
        ...
        ProtocolLibrary.getProtocolManager().getPacketListeners().forEach(listener -> {
            ...
            System.out.println("Removed listener " + listener.getClass().getName());

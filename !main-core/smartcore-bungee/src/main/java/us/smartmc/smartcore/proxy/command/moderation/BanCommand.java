...
import us.smartmc.smartcore.proxy.util.SanctionTimeUtils;
...
public class BanCommand extends CoreCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        SanctionsManager.create(uuid, creatorId, SanctionType.BAN, timeUtils, reason);
